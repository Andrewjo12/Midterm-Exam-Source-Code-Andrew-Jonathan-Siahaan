...
DATA_DIR = 'C:\\UTSMACHINEVISION\\data\\archive'
FILE_PATH = os.path.join(DATA_DIR, 'emnist-letters-train.csv')

OUTPUT_DIR = 'C:\\UTSMACHINEVISION\\data\\archive\\output'
...
#MODE PENGGUNAAN (dapat diatur disini)
...
def plot_confusion_matrix(y_true, y_pred, kernel_name):
    ...
    filename = f'hasil confusion_matrix_hog_svm_{kernel_name}.png'
